    ...
    this.db.transaction(() => {
      ...
      this.db.run(
        `INSERT INTO device_realtime_state (
           ...
           today_usage_ms, updated_at, last_heartbeat_at, is_online
         ) VALUES (
           @deviceId, @packageName, @appName, @iconHash, @foregroundStartedAt,
           @todayUsageMs, @updatedAt, @lastHeartbeatAt, 1
         )
      ...
      this.db.run(
        `INSERT INTO daily_device_stats (
         ...
         DO UPDATE SET
           ...
           total_notification_count = excluded.total_notification_count,
